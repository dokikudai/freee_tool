...
function calc_child_care(start_date, end_date,    i) {
  cmn_debug_log("#calc_child_care,  $77=" $col_to_idx[hp_idx]["厚生年金保険標準報酬月額"])
  i = (lib_si_child[start_date][end_date][CHILD_CARE_PERCENTAGE] / 100) * $col_to_idx[hp_idx]["厚生年金保険標準報酬月額"]
